...
def main():
    model = shufflenetv2.create_MobileNet()
    target_layers = [model.conv_last]
    ...
    # load image
    img_path = 'brush_hair.avi'#"both.png"
    ...
    target_category = 90  # tabby, tabby cat
